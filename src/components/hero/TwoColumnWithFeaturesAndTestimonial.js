...
const ControlButton1 =styled(PrimaryButton)`
  ${tw`text-pink-500  px-8 py-3   border border-pink-700 text-xl font-bold  bg-white text-pink-500  text-xl hocus:bg-pink-700 hocus:text-white focus:shadow-outline flex items-center justify-center  last:mr-0`}
  img {
    ${tw`w-8 h-8 mr-2`}
  }
`;
